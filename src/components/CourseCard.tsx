...
export function CourseCard({
  ...
  const enrolled = EnrollmentService.isEnrolled(courseIdStr);
  ...
  const handleStartLearning = (e: React.MouseEvent) => {
    ...
    if (!EnrollmentService.isEnrolled(courseIdStr)) {
      EnrollmentService.enroll(courseIdStr);
    }
    navigate(`/course/${courseIdStr}/content`);
  };
          ...
          <div className="space-y-3">
            <div className="flex gap-3">
              ...
              >
                ...
                {enrolled ? "متابعة التعلم" : "ابدأ التعلم"}
              </Button>
