...
import { EnrollmentService } from "@/utils/enrollment";
...
export default function DashboardPageNew() {
  ...
  useEffect(() => {
    ...
    // تحديث اسم المستخدم من localStorage
    try {
  ...
  // Determine enrolled courses for the current student
  const enrolledIds = EnrollmentService.getEnrolledCourseIds();
                ...
                {enrolledCourses.length === 0 ? (
                  <Card className="md:col-span-2 lg:col-span-3 border-2">
                    <CardContent className="p-8 text-center">
                      <h3 className="text-xl font-bold mb-2 font-arabic">لا توجد كورسات مسجل بها بعد</h3>
                      <p className="text-muted-foreground font-arabic mb-4">ابدأ رحلتك التعليمية الآن باختيار المواد التي تهمك</p>
                      <Button onClick={() => navigate('/courses')} className="font-arabic">تصفح المواد</Button>
                    </CardContent>
                  </Card>
                ) : (
                          ...
                          <div className="p-6">
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="flex items-center justify-between text-sm">
                                ...
                                <span className="font-medium text-gray-900 dark:text-white">ابدأ من المحاضرة الأولى</span>
                              </div>
                              
                              <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                                <Calendar className="w-4 h-4" />
                                <span>جاهز للبدء الآن</span>
                              </div>
                            </div>
                            
                            <Button className="w-full mt-4 bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-700 hover:to-teal-800" onClick={() => navigate(`/course/${course.id}/content`)}>
                              متابعة التعلم
                            </Button>
                          </div>
                        </CardContent>
