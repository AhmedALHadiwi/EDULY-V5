...
const months = [
  {
    ...
    lessons: [
      ...
      { 
        id: 3, 
        title: "حل المعادلات بطرق مختلفة", 
        duration: "50 دقيقة", 
        type: "video", 
        isCompleted: true, 
        isUnlocked: true,
...
export default function CourseDetailsPage() {
  ...
  const handleEnrollment = () => {
    // Require authentication, then enroll and redirect to content page
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-center">
                      ...
                      <div className="p-3 bg-muted/30 rounded-lg">
                        ...
                        <div className="text-xs text-muted-foreground font-arabic">امتحانات مكتملة</div>
                      </div>
                    </div>
                  </>
                )}
