...
// تستمد قائمة المواد من السياق حتى تظهر مواد الأدمين للطلاب
const categories = [
...
export default function CoursesPage() {
  ...
  const filteredCourses = allCourses.filter(course => {
    ...
    const matchesGrade = selectedGrade === "الكل" || (course as any).grade === selectedGrade;
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            <p className="text-muted-foreground font-arabic">
              عرض {sortedCourses.length} من {allCourses.length} مادة
            </p>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex gap-2">
                          ...
                          {(course as any).grade && (
                            <Badge variant="secondary" className="font-arabic">{(course as any).grade}</Badge>
                          )}
                        </div>
              ...
              >
                <CardContent className="p-0">
                  ...
                  <p className="text-sm text-muted-foreground font-arabic">
                    {allCourses.filter(c => c.category === category.value).length} مادة
                  </p>
                </CardContent>
              </Card>
            ))}
